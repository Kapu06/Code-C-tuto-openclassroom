...
while (coupsRestant !=0)
{
    ...
    scanf("%c",&maLettre);
    /*maLettre=lirecaractere(); L'invite de commande s'arrête ici =/, ne s'y arrête pas quand simple scanf */
    ...
    {
        printf("Voici ce que tu as trouvé: %c", *pointeurRecherche);//Affiche tout le reste du mot, pas uniquement la/les lettres trouvées
    }
    coupsRestant--;
    compteurCoups++;
